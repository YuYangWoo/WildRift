...
class ItemFragment(val tabTitle: Int) : BaseFragment<FragmentItemBinding>(R.layout.fragment_item) {
    private val model by lazy { ViewModelProvider(this, ItemFragmentViewModelFactory(this)).get(ItemFragmentViewModel::class.java) }
